...
def bond():
    bond = Bond(
        par=random.randint(0,10e12), # Random par between 0 and 1 000 000 000 000 (0 and 10e12)
        coupon=random.random(), # Random coupon between 0,00 % and 100,00 % (0 and 1)
        frequency=random.choice([1, 2, 4, 12]), # Random frequency in 1, 2, 4 or 12 months
